export const en = {
  ...
  hero: {
    ...
    titlePre: 'The ',
    titleShine: 'searchable memory',
    titleMid: ' of ',
    titleMarker: 'everything your team ships.',
    titlePost: '',
    subtitle:
      'Driff turns every PR, push and release into a clear summary, automatically, and keeps your whole history in one place. Stop writing status updates and digging through changelogs: just ask what shipped, when and by whom.',
    ctaPrimary: 'Get early access',
    ctaSecondary: 'See how it works',
    microcopy: 'Free during early access · ~5-min setup · Invite-only',
  },
  preview: {
  ...
  features: {
    ...
    featuredTitle: 'Unified feed + metrics',
    featuredDesc: "All your team's progress in one place, with the metrics that matter.",
    stats: [
    ...
    cards: [
      {
        title: 'Ask Driff',
        desc: "Ask your team's history in plain language and get a sourced answer.",
      },
      {
        title: 'Automatic summaries',
        desc: 'Every PR, push and release becomes a clear, professional summary.',
      },
      {
        title: 'Version changelogs',
        desc: 'Bump the version and get a ready-to-share changelog.',
      },
    ],
  },
  ask: {
    ...
    demoReply:
      "In the product, I answer this from your team's real history of PRs, pushes and releases. This is a quick demo, so try one of the suggestions to see a full answer.",
  },
  changelog: {
  ...
  integrations: {
    ...
    caption: '6 integrations available in early access · the rest in active development.',
  },
  beforeAfter: {
  ...
  whitelist: {
    badge: 'Early access · 8 to 15 teams',
    title: 'Get early access to Driff.',
    subtitle:
      'Free during early access, direct support from us and real influence on the product. Leave your email and we’ll be in touch.',
    name: 'Your name',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        a: "During early access it's completely free. Paid plans come later, based on usage, projects, destinations and summary volume.",
      },
      {
