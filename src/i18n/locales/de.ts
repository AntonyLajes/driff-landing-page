...
export const de: Resources = {
  ...
  preview: {
    ...
    rows: [
      {
        title: 'Streak Freeze: behalte deine Serie mit einem freien Tag pro Woche',
        meta: 'PR #142 · feature/streak-freeze → main  ·  +210 −18 · 6 Dateien',
        time: 'jetzt',
      },
      {
        title: 'Fix: Serien werden um Mitternacht in anderen Zeitzonen zurückgesetzt',
        meta: 'Push · main · a1b2c3d  ·  +12 −3 · 2 Dateien',
        time: '2 Std.',
      },
      {
  ...
  ask: {
    ...
    q2: 'Was hat sich letzten Monat bei Erinnerungen geändert?',
    a2: 'Drei Änderungen: intelligenteres Erinnerungs-Timing basierend auf dem Verlauf, ein Fix für den Mitternachts-Reset je Zeitzone und Ruhezeiten. Keine Breaking Changes.',
  ...
  changelog: {
    ...
    groups: [
      ...
      },
      {
        ...
        items: [
          'Intelligenteres Erinnerungs-Timing basierend auf dem Verlauf jeder Gewohnheit',
          'Startbildschirm lädt schneller bei Konten mit über 50 Gewohnheiten',
        ],
      },
      {
        label: 'Fixes',
        items: [
          'Behoben: Serien wurden um Mitternacht in Nicht-UTC-Zeitzonen zurückgesetzt',
          'Erinnerungen werden während der Ruhezeiten nicht mehr ausgelöst',
        ],
      },
    ],
  },
